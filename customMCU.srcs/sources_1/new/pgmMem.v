...
module pgmMem(
    ...
    begin
        ...
        mem[132] = 16'b0111_0110_0000_0000; //cmb
        mem[133] = 16'b0011_0000_0000_1000; //stb
        mem[134] = 16'b0000_0000_0000_1000; //lda
        mem[135] = 16'b0111_0001_0000_1000; //add
        mem[136] = 16'b0100_0000_0000_0011; //jmp
        mem[137] = 16'b0111_0011_0000_0000; //cla
        mem[138] = 16'b0111_0100_0000_0000; //clb
