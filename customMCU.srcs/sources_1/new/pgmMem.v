...
module pgmMem(
    ...
    begin
        ...
        mem[2] = 16'b0100_0000_0000_1000;   //jmp
        mem[3] = 16'b0010_0000_0000_1000;   //sta
        
        mem[8] = 16'b0111_0001_0000_1000; //add
        mem[9] = 16'b0010_0000_0000_1000; //sta
        mem[10] = 16'b0001_0000_0000_1000; //ldb
        mem[11] = 16'b0111_0101_0000_0000; //cmb
        mem[12] = 16'b0111_0110_0000_0000; //cmb
        mem[13] = 16'b0011_0000_0000_1000; //stb
        mem[14] = 16'b0000_0000_0000_1000; //lda
        mem[15] = 16'b0111_0001_0000_1000; //add
        mem[16] = 16'b0100_0000_0000_0011; //jmp
        mem[17] = 16'b0111_0011_0000_0000; //cla
        mem[18] = 16'b0111_0100_0000_0000; //clb
